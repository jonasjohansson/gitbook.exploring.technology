...
{% hint style="info" %}
Components are fantastic! If you want to understand them further, and maybe create your own, [read the documentation](https://aframe.io/docs/1.0.0/core/component.html).
{% endhint %}
